...
- Password can be changed from the Entries screen after login.
- Note: This is an app-level local login; it is not a server-side security/authentication system.
